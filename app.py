...
def main():
    ...
    with st.sidebar:
        ...
        docs = st.file_uploader(
            "Upload your PDFs, DOCX, or TXT files here and click on 'Process'",
            type=["pdf", "docx", "txt"],
        ...
        # Add extraction and download JSON button
        if docs and st.button("Extract Documents to JSON"):
            raw_text = get_documents_text(docs)
            data = {
                "header": raw_text,
                "List_items": []  # Table extraction not implemented
            }
